...
: ${AMENT_CURRENT_PREFIX:="/home/sakshi/ClutterBot/install/task"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/task/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/task/environment/path.sh"
